...
public final class ClipboardMonitor: ObservableObject {
    ...
    public static func shouldIgnore(types: [String]) -> Bool {
        ...
        return types.contains { ignoredTypes.contains($0) }
    }
    ...
    public func readCurrent() -> String? {
        ...
        guard !Self.shouldIgnore(types: types) else { return nil }
    ...
    private func checkClipboard() {
        ...
        let types = pasteboard.types?.map { $0.rawValue } ?? []
        guard !Self.shouldIgnore(types: types) else { return }
